 ...
 * @author sadev_vr38
 */
@WebServlet(name = "AdminLoadRentals", urlPatterns = {"/AdminLoadRentals"})
public class AdminLoadRentals extends HttpServlet {
        ...
        if (httpSession.getAttribute("id") != null && httpSession.getAttribute("email") != null) {
            ...
            if (!adminCriteria.list().isEmpty()) {
                ...
                if (!criteria.list().isEmpty()) {
                    ...
                    List<Rentals> rentals = criteria.list();
                    ...
                    responseJson.add("rentals", gson.toJsonTree(rentals));
