 ...
 * @author sadev_vr38
 */
@WebServlet(name = "AdminLoadUsers", urlPatterns = {"/AdminLoadUsers"})
public class AdminLoadUsers extends HttpServlet {
        ...
        if (httpSession.getAttribute("id") != null && httpSession.getAttribute("email") != null) {
            ...
            if (!adminCriteria.list().isEmpty()) {
                ...
                if (!criteria.list().isEmpty()) {
                    ...
                    responseJson.add("users", gson.toJsonTree(users));
                    
                }else{
                    
                    responseJson.addProperty("message", "No Users!");
